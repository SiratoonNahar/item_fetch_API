...
import ReCaptchaComponent from "./recapcha";
         ...
         <div className="stories-list" onDragOver={handleDragOver} onDrop={handleDrop}>
            {Array.isArray(stories) && stories.length > 0  ? (
               stories.map((story, index) => (
                  ...
                  >
                     <h2 className="story-title">{story.title || "No Title"}</h2>
                     <p className="author_nme">By {story.author || "Unknown"}</p>
                     <a className="read_stry"
                        href={story.url}
                        target="_blank"
